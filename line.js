...
//Read the data
d3.csv("https://raw.githubusercontent.com/VenkataRevanthNaidu/DatavizG14/main/trend3.csv").then( function(data) {
    ...
    const x = d3.scaleLinear()
      .domain(d3.extent(data, function(d) { return d.CrimeYear; })).nice()
      .range([ 0, width ]);
    svg.append("g")
    ...
    function update(selectedGroup) {
      ...
      const dataFilter = data.filter(function(d){return d.Neighbourhood==selectedGroup})
