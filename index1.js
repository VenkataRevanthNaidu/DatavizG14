...
d3.json("https://raw.githubusercontent.com/VenkataRevanthNaidu/DatavizG14/main/Community_Statistical_Areas__CSAs___Reference_Boundaries.geojson").then(function(data){
	d3.csv("https://raw.githubusercontent.com/VenkataRevanthNaidu/DatavizG14/main/crime_Trend.csv").then(function(dataset){
console.log(data)
	svg.append("g")
		.selectAll("path")
		.data(data.features)
        ...
        var county =svg.append("g")
			...
			.attr("d",d3.geoPath()
					.projection(projection)
                            ...
                            .style("stroke","white")
                            .style("stroke", "transparent")
                            .attr("class", function(d){ return "Community" })
                            .style("opacity", .8)
...
const myColor = d3.scaleOrdinal()
 ...
 const x = d3.scaleLinear()
      .domain(d3.extent(data, function(d) { return d.Cases; })).nice()
      .range([ 0, width ]);
    svg1.append("g")
...
const y = d3.scaleLinear()
      .domain([0, d3.max(data, function(d) { return +d.count; })]).nice()
      .range([ height, 0 ]);
    svg1.append("g")
      .call(d3.axisLeft(y));
    const line = svg1
      ...
      .append("path")
        ...
        .style("fill", "none")
                              ...
                              document.getElementById("details").innerHTML="<b>Total Crimes: "+namecity[i.properties.Community]
                                                                          + ", Neighbourhood: "+[i.properties.Community]
                            })
